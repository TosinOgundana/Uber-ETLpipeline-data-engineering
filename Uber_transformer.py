...
def transform(df, *args, **kwargs):
    ...
    fact_table = df.merge(passenger_count_dim, left_on='trip_id',right_on='passenger_count_id')              .merge(trip_distance_dim, left_on='trip_id', right_on='trip_distance_id')              .merge(rate_code_dim, left_on='trip_id', right_on='rate_code_id')              .merge(payment_type_dim, left_on='trip_id', right_on='payment_type_id')              .merge(drop_location_dim, left_on='trip_id', right_on='drop_location_id')              .merge(pickup_location_dim, left_on='trip_id', right_on='pickup_location_id')              .merge(datetime_dim, left_on='trip_id', right_on='datetime_id')              [['VendorID', 'datetime_id','rate_code_id', 'passenger_count_id', 'trip_distance_id', 
